...
cl = Han.LINE()
cl.login(token="ErmbJbW9uxomhRVy2GR3.FZUQmFgOrJXcrZZJ/v6FKW.Ogv0+OK8R441SlLu/uGtP6pVfyxxXoD9Nbpp5ljqgsA=")
cl.loginResult()

kt = Han.LINE()
kt.login(token="ErU8nNJN2HZFz9fLrfR0.7J7tf2cg5VaiReeN1t384a.hlKNl/DVR33ibjHVHNETC9pVXvD1F45SIinqvs/K4Q8=")
kt.loginResult()

ks = Han.LINE()
ks.login(token="ErzFvDDksYSnkrYiwYfb.jYZnc8Ri+w2ftRXhyFIIgW.PC1ri6Iw5jnNSDtNmdBhgLUgHR+N8gRY2oU235cVd34=")
ks.loginResult()

ki = Han.LINE()
ki.login(token="EruoJlZccX9dhtTuV1i1.jvqjlE8sqqkPd8NlsIsduq.FoFFcPYxXQswX9E4CWfCv6apRBzZibx7IUMaYOUksn8=")
ki.loginResult()

kk = Han.LINE()
kk.login(token="ErGIkAkK0lRRo7wRRye2.Zx6Pd/ljj578QVMbdh3ZuG.Hg02S3WhNJyyAWL8zRJOZ+2DeX4tA6axD9r5Ps0xjXI=")
kk.loginResult()

kc = Han.LINE()
kc.login(token="EreemtxaITMs564ep202.+ZKWkMBJzChJtyl9STlVCG.3UIm7gzr+6XY+k8N8fnLaO7Xis23Ng5/pj092G8dpns=")
kc.loginResult()

kl = Han.LINE()
kl.login(token="ErQBC7rfPEjuX5DJmVm0.iwF+jdWziryIs1wRU7TNSa.xWc4FKkhAoHvPX57VlPXHBh2BQ3AJ1DG+Qtua4LC03Y=")
kl.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u57edc3056a172603616a8e808172b672"]
admin = ["u57edc3056a172603616a8e808172b672"]
owner = ["u57edc3056a172603616a8e808172b672"]
creator=["u57edc3056a172603616a8e808172b672"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"ᎢᎻᎪNKᏚ FᎾᎡ ᎪᎠᎠ ᎷᎬ\nᎪKᏌ ᏩᎪ ᏓᎪᏔᎪᏴ ᏢᎷ KᎪᎡNᎪ ᎪKᏌ ᏟᏌᎷᎪ ᏴᎾᎢ\nᏌNᎢᏌK ᏆNFᎾ ᏞᎬᏴᏆᎻ ᏞᎪNᏓᏌᎢ ᏚᏆᏞᎪᎻKᎪN ᏢᎷ http://line.me/ti/p/FUcag6looe",
    "lang":"JP",
...
#Tolong Jangan Ganti mid CreatorNya Hargai Saya yang membuat!!!#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u57edc3056a172603616a8e808172b672'}
                cl.sendMessage(msg)
